      	...
      	success:function(respuesta){
			...
			// var precio_compra = respuesta["precio_compra"];
			  ...
			  '<div class="col-xs-3">'+
	             ...
	             '<input type="text" class="form-control nuevoUnidad" idProducto="'+idProducto+'" name="nuevoUnidad" value="'+unidad+'" readonly required>'+
...
//     var precioTotal = $("#nuevoTotalVenta").attr("total") || 0;
...
/*=============================================
CUANDO SE ACTIVA O DESACTIVA EL IMPUESTO
=============================================*/

// $("#activarImpuesto").change(function(){
//     if (this.checked) {
